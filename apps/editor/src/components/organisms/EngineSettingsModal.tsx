          ...
          {(desc) => (
            <div class="flex items-center justify-between gap-4 px-3 py-1">
              ...
              <Show
                fallback={
                  <input
                    class="h-5 w-16 rounded border border-outline-variant bg-transparent px-1 text-right text-on-surface text-xs outline-none focus:border-primary focus:outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40"
