...
export const getQuickjsSettings = () =>
	_useSettingsStore.getState().config.quickjs;
export const getMaxLogs = () => _useSettingsStore.getState().config.maxLogs;
export const getAutorunTimeout = () =>
	_useSettingsStore.getState().config.autoRunTimeout;
export const getIsAutorunEnable = () =>
	_useSettingsStore.getState().config.autoRun;
