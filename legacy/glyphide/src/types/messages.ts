...
export const ExecutionResultPayloadSchema = z
	...
	.refine(
		...
		{
			message:
				"Payload must contain 'result' on success and 'error' on failure.",
		},
	);
...
export const MainToWorkerMessageSchema = z.discriminatedUnion("type", [
	z.object({
		type: z.literal(MessageTypes.INIT_WORKER),
		payload: InitWorkerPayloadSchema,
	}),
	z.object({
		type: z.literal(MessageTypes.EXECUTE_CODE),
		payload: ExecuteCodePayloadSchema,
	}),
	z.object({
		type: z.literal(MessageTypes.TERMINATE_EXECUTION),
...
export const WorkerToMainMessageSchema = z.discriminatedUnion("type", [
	z.object({
		type: z.literal(MessageTypes.WORKER_READY),
		payload: z.undefined().optional(),
	}),
	z.object({
	...
	z.object({
		type: z.literal(MessageTypes.EXECUTION_ERROR),
		payload: ExecutionErrorPayloadSchema,
	}),
]);
